...
public $annonces = array('id','produit','date','reduction','active','bloque','lancepage');
...
public $produits = array('id','designation','genre','marque','poids','codebar','description','ingredient','image','image2','image3');
